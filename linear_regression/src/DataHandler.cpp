...
DataHandler::DataHandler(std::string data, std::string separator, bool head) : dataset(data), delimiter(separator), header(head)
{
    std::cout << "The constructer has been called!" << std::endl;
}

DataHandler::~DataHandler()
{
    std::cout << "The destructer has been called!" << std::endl;
}
