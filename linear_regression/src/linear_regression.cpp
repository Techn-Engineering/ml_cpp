...
float linear_regression::OLS_Cost(Eigen::MatrixXd X, Eigen::MatrixXd y, Eigen::MatrixXd theta){
...
std::tuple<Eigen::VectorXd,std::vector<float>> linear_regression::GradientDescent(Eigen::MatrixXd X, Eigen::MatrixXd y, Eigen::VectorXd theta, float alpha, int iters){
...
float linear_regression::RSquared(Eigen::MatrixXd y, Eigen::MatrixXd y_hat){
